...
# @contextlib.contextmanager 是一个装饰器，由它修饰的方法会有两部分构成，
# 中间由 yield 关键字分开。由此方法创建的上下文管理器，在代码块执行前会先
# 执行yield上面的语句，在代码块执行后会再执行yield下面的语句。 https://blog.csdn.net/l1l1l1l/article/details/92702773
